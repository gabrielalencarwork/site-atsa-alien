...
export function FloatingWhatsApp() {
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-full mr-4 bg-white text-gray-800 text-xs px-3 py-1.5 rounded shadow opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none font-sans font-medium">
        Fale com a gente!
      </span>
    </a>
  )
